...
COPY ./executor/enabled/_31050_executordashboard.py ./horizon/openstack_dashboard/local/enabled/
COPY ./executor/local_settings.d/_9900_executor_settings.docker.py ./horizon/openstack_dashboard/local/local_settings.d/
